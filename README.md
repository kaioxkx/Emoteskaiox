...
NotifGui.Parent = RunService:IsStudio() and Player.PlayerGui or Services.CoreGui;
NotifGui.DisplayOrder = 69
...
return {
	...
	if (Title) or (Description) then
		...
		NewLabel.Size = UDim2.new(1, 0, 0, Y + 6);
		...
		if (Description) then
			...
			NewDescription.Size = UDim2.fromScale(1, 1) + UDim2.fromOffset(-DescriptionPadding, Title and -32 or -6);
